...
class DMContainerGroup;
class QLineEdit;

namespace Ui {
class DMGUIContainerGroup;
}

class DM_HELPER_DLL_EXPORT DMGUIContainerGroup: public QDialog
{
	Q_OBJECT

public:
	explicit DMGUIContainerGroup(DMContainerGroup * m, QWidget *parent = 0);
	~DMGUIContainerGroup();

private:
	Ui::DMGUIContainerGroup*		ui;
	DMContainerGroup*				m;
