...
#include "dmguicontainergroup.h"
#include "ui_dmguicontainergroup.h"
...
DMGUIContainerGroup::DMGUIContainerGroup(DMContainerGroup * m, QWidget *parent):
	QDialog(parent),
	ui(new Ui::DMGUIContainerGroup)
{
	ui->setupUi(this);
...
DMGUIContainerGroup::~DMGUIContainerGroup()
{
	delete ui;
}

DM::Module::Parameter* DMGUIContainerGroup::getParam(const std::string& originalParamString)
{
...
void DMGUIContainerGroup::on_addParameter_clicked()
{
...
void DMGUIContainerGroup::on_rmParameter_clicked()
{
...
void DMGUIContainerGroup::on_selectedParameters_itemSelectionChanged()
{
...
void DMGUIContainerGroup::on_editParamName_textEdited(const QString& newText)
{
	foreach(QListWidgetItem* it, ui->selectedParameters->selectedItems())
		m->parameterConfig[it->text().toStdString()] = newText.toStdString();
}

void DMGUIContainerGroup::openFileDialog(QString label)
{
...
void DMGUIContainerGroup::addParameterEdit(std::string name, std::string id)
{
...
void DMGUIContainerGroup::on_tabWidget_currentChanged()
{
...
void DMGUIContainerGroup::insertStreamEntry(std::string name, bool out)
{
	if(out)
...
void DMGUIContainerGroup::on_addInStream_clicked()
{
...
void DMGUIContainerGroup::on_addOutStream_clicked()
{
...
void DMGUIContainerGroup::on_removeStream_clicked()
{
...
void DMGUIContainerGroup::on_enableConfig_stateChanged(int state)
{
	if(state > 0)
...
void DMGUIContainerGroup::accept()
{
