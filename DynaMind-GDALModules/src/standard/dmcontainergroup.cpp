...
DM_DECLARE_CUSTOM_NODE_NAME(DMContainerGroup,Module Grouping, Workflow Control)
...
void DMContainerGroup::run()
{
}

void DMContainerGroup::init()
{
	Group::init();
...
bool DMContainerGroup::addStream(std::string name, bool out)
{
...
bool DMContainerGroup::initStream(std::string name, bool out, bool silent)
{
...
bool DMContainerGroup::removeStream(std::string name)
{
...
bool DMContainerGroup::createInputDialog()
{
	QWidget * w = new DMGUIContainerGroup(this);
	w->show();
	return true;
}
