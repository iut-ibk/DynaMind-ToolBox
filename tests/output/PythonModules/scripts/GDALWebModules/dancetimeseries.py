        ...
        def createTimeseries(self, cur, measurment_type_id, name, start_date, end_date):
            ...
            for station in self.node_station:
                ...
                if len(times) != 2:
                    ...
                    log("SELECT date from " + str(self.table) + " WHERE station_id = " + str(station_id) + " AND measurment_type_id=" + str(measurment_type_id) + filter_query + " ORDER BY date ASC LIMIT 2 " , Warning)
                    continue
