...
void UnitTestWaterBalance::SetUp()
{
	...
	DM::PythonEnv::getInstance()->addPythonPath("./CD3Modules/CD3Waterbalance/Module/");
	DM::PythonEnv::getInstance()->addPythonPath("./CD3Modules/CD3Waterbalance/WaterDemandModel/");
}
...
#ifdef WATERBALANCE
TEST_F(UnitTestWaterBalance,testEnviroment)
{
	ASSERT_TRUE(sim!=0);
...
//	wb1.setEvapofile("/Users/christianurich/Documents/DynaMind-ToolBox/Data/Raindata/melb_eva_24.ixx");
//	wb1.setRainfile("/Users/christianurich/Documents/DynaMind-ToolBox/Data/Raindata/melb_rain_24.ixx");
//	wb1.initmodel();
