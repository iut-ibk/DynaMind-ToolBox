...
//RasterData
void DataBase::setRasterData(std::string UUID, std::string Name,  RasterData &r) {
...
std::vector<std::string> DataBase::getRegisteredDatasets() const {
...
RasterData & DataBase::getRasterData(std::string UUID, std::string Name, bool read, bool fromBack) {
...
RasterData & DataBase::createRasterData(std::string UUID, std::string Name) {
    RasterData * r = new RasterData();
    r->setName(Name);
    r->setUUID(UUID);
...
//VectorData
VectorData & DataBase::getVectorData(std::string Name) {
...
VectorData & DataBase::getVectorData(std::string UUID, std::string Name, bool read, bool fromBack) {
    if (fromBack) {
...
VectorData & DataBase::createVectorData(std::string UUID, std::string Name) {
    VectorData * v = new VectorData();
    v->setName(Name);
    v->setUUID(UUID);
...
void DataBase::setVectorData(std::string UUID, std::string Name,  VectorData &v) {
...
//DoubleData
double DataBase::getDoubleData(std::string UUID, std::string Name, bool read, bool fromBack) {
    if (read) {
...
void DataBase::createDoubleData(std::string UUID, std::string Name) {
    DoubleDataMaps_0[createName(UUID, Name)] = 0;
    DoubleDataMaps_1[createName(UUID, Name)] = 0;
}

void DataBase::setDoubleData(std::string UUID, std::string Name,  double v) {
...
std::string DataBase::createName(std::string UUID, std::string Name) {
    std::stringstream ss;
    ss <<  UUID;
    ss << "_";
    ss << Name;
...
std::vector<std::string> DataBase::getRegisteredDatasetForModule(std::string identifier) const {
    std::vector<std::string> names;
