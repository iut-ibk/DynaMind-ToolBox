...
DM_DECLARE_NODE_NAME(urbandevelSetAvailable, DynAlp)

urbandevelSetAvailable::urbandevelSetAvailable()
{
...
void urbandevelSetAvailable::init() {
...
void urbandevelSetAvailable::run()
{
